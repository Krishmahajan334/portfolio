...
export const GithubStats: React.FC = () => {
  ...
  const pinnedRepos: PinnedRepo[] = [
    {
      name: "Tagtrix",
      description: "A smart RFID-based access control solution designed to secure institutional resources like electricity and water by linking identity verification with relay activation.",
      stars: 12,
      forks: 4,
      language: "C++",
      langColor: "#f34b7d",
      url: "https://github.com/Krishmahajan334/Tagtrix",
      techStack: ["RFID Telemetry", "Embedded C++", "Microcontrollers", "Relay Actuators", "Usage Tracking"],
    },
    {
      name: "AquaSense",
      description: "An IoT smart water diagnostics system deploying flow sensors and ESP32/ESP8266 valves to track and balance real-time consumption.",
      stars: 8,
      forks: 3,
      language: "C++",
      langColor: "#f34b7d",
      url: "https://github.com/Krishmahajan334/AquaSense",
      techStack: ["ESP32 / ESP8266", "Embedded C++", "Flow Telemetry", "Servo-Valves", "Dashboards"],
    },
    {
      name: "Hand-Gesture-Vocalizer",
      description: "A smart gestural translation device reading flex sensors to convert physical sign language sequences into real-time TTS speech.",
      stars: 7,
      forks: 2,
      language: "C++",
      langColor: "#f34b7d",
      url: "https://github.com/Krishmahajan334/Hand-Gesture-Vocalizer",
      techStack: ["Arduino Uno R3", "Flex Sensors", "MPU6050 IMU", "Signal Fusion", "TTS Synthesizers"],
    },
    {
      name: "Life-Protector-on-Roads",
      description: "An edge collision telemetry warning array detecting high-G impact to autonomously dispatch emergency alerts with GPS locations.",
      stars: 5,
      forks: 1,
      language: "C++",
      langColor: "#f34b7d",
      url: "https://github.com/Krishmahajan334/Life-Protector-on-Roads",
      techStack: ["Arduino Uno", "GSM SIM800C", "GPS 6MV2", "MPU6050 IMU", "Shock Sensors"],
    },
  ];
