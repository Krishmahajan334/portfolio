...
const LineWaves = dynamic(() => import("./LineWaves").then((mod) => mod.LineWaves), { ssr: false });
const Canvas3DParticles = dynamic(() => import("./Canvas3DParticles").then((mod) => mod.Canvas3DParticles), { ssr: false });
